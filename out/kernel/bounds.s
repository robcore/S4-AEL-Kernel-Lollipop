...
@ /media/root/robcore/android/S4-AEL-Kernel-Lollipop/kernel/bounds.c
@ -mlittle-endian -marm -mapcs -mno-sched-prolog -mabi=aapcs-linux
@ -mno-thumb-interwork -mcpu=cortex-a15 -mfloat-abi=soft -munaligned-access
@ -mfpu=neon-vfpv4 -mtls-dialect=gnu -auxbase-strip kernel/bounds.s -O3
...
foo:
	...
	sub	fp, ip, #4	@,,
#APP
@ 17 "/media/root/robcore/android/S4-AEL-Kernel-Lollipop/kernel/bounds.c" 1
	
->NR_PAGEFLAGS #24 __NR_PAGEFLAGS	@
@ 0 "" 2
@ 18 "/media/root/robcore/android/S4-AEL-Kernel-Lollipop/kernel/bounds.c" 1
	
->MAX_NR_ZONES #3 __MAX_NR_ZONES	@
@ 0 "" 2
@ 19 "/media/root/robcore/android/S4-AEL-Kernel-Lollipop/kernel/bounds.c" 1
